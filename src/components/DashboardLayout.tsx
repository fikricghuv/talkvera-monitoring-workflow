...
import { ChartPie, CircleUserRound, UserRoundPen, LogOut } from "lucide-react";
...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  const handleProfile = () => {
    ...
    navigate("/profile"); // uncomment jika sudah ada route profile
  };
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="icon" className="rounded-full">
                  <CircleUserRound className="w-6 h-6 !w-6 !h-6" />
                </Button>
              </DropdownMenuTrigger>
